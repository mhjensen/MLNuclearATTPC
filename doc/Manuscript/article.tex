...
A set of $N=40000$ simulated AT-TPC events per class was obtained  from a ${}^{46}$Ar$(p, p)$ experiment with the \texttt{pytpc} package developed by \citet{Bradt2017a}. %, see table \ref{tab:class_distr}. %Using the same parameters {\color{blue} what parameters are you referring to? -MPK} as for the 
...
While we denote these events as raw, it is important to note that what we intend is a raw two-dimensional projection of events.
...
MHJ’s work is supported by U.S. National Science Foundation Grants No. PHY-1404159 and PHY-2013047. This project has also received support from the INTPART project of the Research Council of Norway (Grant No. 288125) and the Davidson Research Initiative. 
