...
First, the time-series data was represented as a 3D point cloud, where each point contains the maximum charge in the time-series trace. We log-transform to map the charge to the interval $[0, 1]$ for each point, then standardize the data. in the charge time-series and summing over the time-axis.
%
