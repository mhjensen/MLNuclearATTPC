...
\subsection{Standard approaches to analyze the data} 
Brute force serving as motivation for why we do unsupervised learning.
Supervised learning as well.

\section{From supervised approaches to unsupervised methods to classify events}\label{sec:methods}
