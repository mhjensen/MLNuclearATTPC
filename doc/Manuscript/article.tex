...
% Begin added by DB (6/17/2020)
The purpose of this study is to explore the application of unsupervised learning algorithms to event identification from an active target detector. The necessity of identifying events from raw data prior to 
% End added by DB (6/17/2020)
